...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView.setText(R.string.usuarioGAM); //hardcodeo el usuario
    }
...
//            }
        ...
        private void configureServiceURL() {
                ...
                if (TestMode == Boolean.TRUE){
                    ...
                    serviceURL = serviceURL.replace("rest/LocationHistory/","oauth/access_token");
                    Log.d(TAG,"Test Mode On");
                }else{
                    serviceURL = "http://web"+ codigoSucursal.trim()+".ribeiront.net.ar/oauth/access_token";
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                mPasswordView.setError(getLoginError());//getString(R.string.error_incorrect_password)
